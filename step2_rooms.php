        ...
        <div class="clearfix  row-eq-height">
            ...
            <div class="col-sm-12 col-md-6 col-lg-8">
                ...
                <div class="clearfix push-down">
                    ...
                    <div class="col-sm-6">
                        <a href="javascript:void(0)" class="btn btn-default btn-primary btn-lg btn-block btn-raised primary_bg  book-btn-room">ab 324&euro;</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="clearfix  row-eq-height">
            ...
            <div class="col-sm-12 col-md-6 col-lg-8">
                ...
                <div class="clearfix   push-down">
                    ...
                    <div class="col-sm-6">
                        <a href="javascript:void(0)" class="btn btn-default btn-primary btn-lg btn-block btn-raised primary_bg" >ab 325&euro;</a>
                    </div>
                </div>
            </div>
        </div>

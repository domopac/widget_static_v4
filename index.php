    ...
    <div class="jumbotron">
        ...
        <div class="row">
            ...
            <div class="col-xs text-center" id="summary">
                <span id="summary_rooms"></span><span id="summary_persons"></span><span id="summary_kinder"></span><span
                    id="summary_fromDate"></span><span id="summary_toDate"></span>
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="jumbotron col-xs-12" id="room_1_data">
                ...
                <div class="col-xs-12 margin-top">
                    <a href="javascript:void(0)"
                       class="btn btn-default btn-primary btn-lg btn-block btn-raised">Buchen</a>
                    <fieldset disabled="">
                        <a href="javascript:void(0)" class="btn btn-default btn-primary btn-lg btn-block btn-raised">Buchen</a>
                    </fieldset>
                </div>

                <a href="javascript:void(0)" class="btn btn-raised btn-primary" id="add_room"><i
        ...
        <div class="col-sm-8 col-sm-pull-4">
            ...
            <div class="jumbotron col-xs-12">
                ...
                <div id="Bs-DayPicker" class="Bs-DayPicker Bs-Section Bs-DayPicker--valid">
                                ...
                                <div class="DayPicker-Month">
                                    ...
                                    <div class="DayPicker-Body" role="grid">
                                        ...
                                        <div class="DayPicker-Week" role="gridcell">
                                            ...
                                            <div class="DayPicker-Day DayPicker-Day--today DayPicker-Day--bookable DayPicker-Day--first DayPicker-Day--last DayPicker-Day--selected"
    ...
    <div class="jumbotron col-xs-12 no-padding" id="room_1">
        ...
        <div class="col-sm-8">
            ...
            <div> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sit amet molestie tellus.
                ...
                Duis quis semper urna. Nunc viverra mi non egestas luctus. Nullam a tristique nibh. Maecenas eu lacinia
                velit.
